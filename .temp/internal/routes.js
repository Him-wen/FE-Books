...
import GlobalLayout from "/Users/himwen/Develop/Github/FE-Books/node_modules/@vuepress/core/lib/client/components/GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-00ee3ef8").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-be1ba0ea").then(next)
    },
  },
  {
    name: "v-14713a23",
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-b5cc6370").then(next)
    },
  },
  {
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-14576e7a").then(next)
    },
  },
  {
    name: "v-437ef683",
